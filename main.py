...
def recommended_articles():
    ...
    for liked_article in liked_articles:
        output=get_recommendations(liked_article['url'])
        all_recomended=all_recomended.append(output)

    all_recomended.drop_duplicate(subset=['url'],inplace=True)
